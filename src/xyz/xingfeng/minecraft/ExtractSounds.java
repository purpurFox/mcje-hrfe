...
public class ExtractSounds implements Runnable{
    String path;
    String soundsPath;
    String exportPath;
    public ExtractSounds(String path){
        this.path = Window.text.getText() + "/indexes/" + path + ".json";
        this.soundsPath = Window.text.getText() + "/objects/";
